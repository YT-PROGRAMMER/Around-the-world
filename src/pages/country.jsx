...
const Country = () => {
  ...
  const { isError, isLoading, result } = useFetchData(country);
  return (
    <>
              ...
              <div className="flex flex-col gap-8 md:gap-40 lg:flex-row">
                ...
                <div className="flex flex-col gap-5">
                  <p>
                    ...
                    <span>{result?.topLevelDomain?.join(", ")}</span>
                  </p>
                    ...
                    <span className="font-thin">
                      {result?.currencies &&
                        Object.keys(result.currencies).map(
                          (key) => `${result.currencies[key].name}`
                        )}
                    </span>
                  </p>
                  ...
                  <p>
                    ...
                    <span className="font-thin">
                      {result?.languages &&
                        Object.values(result.languages).map(
                          (lang) => `${lang} `
                        )}
                    </span>
                  </p>
